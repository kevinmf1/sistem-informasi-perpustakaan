						...
						<div class="box-body">
							...
							<form method="post" action="<?= base_url('transaksi/dendaproses');?>">
								...
								<label for="">Harga Denda</label>
									<input type="number" name="harga" required  value="<?=$den->harga_denda;?>" class="form-control" placeholder="Contoh : 10000" >
							...
							<form method="post" action="<?= base_url('transaksi/dendaproses');?>">
								<div class="form-group">
								<label for="">Harga Denda</label>
									<input type="number" required name="harga" class="form-control" placeholder="Contoh : 10000" >
								</div>
								<br/>
